    ...
    def __find_min_max_from_fields(self):
        ...
        if 'psl' in self.fields:
            ...
            for i in range(56):
                ...
                self.pmins.append([(self.psl[i][pmin[0], pmin[1]], (self.lons[pmin[1]], self.lats[pmin[0]]))
                              for pmin in index_pmins])
                self.pmaxs.append([(self.psl[i][pmax[0], pmax[1]], (self.lons[pmax[1]], self.lats[pmax[0]]))
